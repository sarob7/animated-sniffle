...
class AgenticTransactionAnalyzer:
    ...
    def _create_agent(self) -> AgentExecutor:
        ...
        system_prompt = (
            ...
            "\n\nUse insights from previous analyses to guide your strategy, as provided in the prompt."
        )
    ...
    def analyze_transaction(self, mtcn: str) -> Dict[str, Any]:
        ...
        2. Based on initial findings and insights from previous analyses, decide what additional information you need
